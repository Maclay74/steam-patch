...
pub fn get_patches() -> Vec<Patch> {
    vec![
        ...
        Patch {
            ...
            replacement_text: "const t=c.Hm.deserializeBinary(e).toObject(); fetch(`http://localhost:1338/update_settings`, { method: 'POST', body: JSON.stringify(t.settings)}); Object.keys(t)".to_string(),
        },
