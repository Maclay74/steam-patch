...
pub struct GlobalConfig {
    ...
    diagnostic_update_rate: Option<i128>,
    force_hdr_10pq_output_debug: Option<bool>,
    force_hdr_wide_gammut_for_sdr: Option<bool>,
    graphics_profiling_service_state: Option<i128>,
    hdr_on_sdr_tonemap_operator: Option<i128>,
    is_advanced_settings_enabled: Option<bool>,
    is_show_perf_overlay_over_steam_enabled: Option<bool>,
    perf_overlay_level: Option<i128>,
    perf_overlay_service_state: Option<i128>,
    sdr_to_hdr_brightness: Option<i128>,
    system_trace_service_state: Option<i128>,
}

#[allow(dead_code)]
#[derive(Deserialize)]
pub struct PerAppConfig {
    cpu_governor: Option<i128>,
    cpu_governor_manual_mhz: Option<i128>,
    display_external_refresh_manual_hz: Option<i128>,
    display_refresh_manual_hz: Option<i128>,
    force_composite: Option<bool>,
    fps_limit: Option<i128>,
    fps_limit_external: Option<i128>,
    fsr_sharpness: Option<i128>,
    ...
    nis_sharpness: Option<i128>,
    split_scaling_filter: Option<i128>,
    split_scaling_scaler: Option<i128>,
